...
* 🌐 𝐅𝐮𝐥𝐥-𝐒𝐭𝐚𝐜𝐤 𝐖𝐞𝐛 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐦𝐞𝐧𝐭: React.js, HTML/CSS/JS, Node.js (Express), Python (Web.py), REST, GraphQL, WebSockets, Auth0, OAuth, GitHub Actions, Docker, Kubernetes, MongoDB, PostgreSQL, MySQL, Redis, AWS, Firebase, Google Cloud
...
* 📱 𝐌𝐎𝐁𝐈𝐋𝐄 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐌𝐄𝐍𝐓: React Native, Firebase, AWS, Google Cloud, push notifications (FCM, OneSignal), payments (Stripe, PayPal)
